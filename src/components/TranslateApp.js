                    ...
                    <div className="rounded-lg border border-gray-300">
                        ...
                        <ul className=" flex items-center justify-between cursor-pointer">
                            <li className=" flex items-center justify-between cursor-pointer ">
                                ...
                                <select className='text-gray-700 border-none outline-none text-lg p-3  mr-5 ' value={fromLanguage} onChange={(e) => setFromLanguage(e.target.value)}>
                            ...
                            <li className=" flex items-center justify-between cursor-pointer">
                                <select className='text-gray-700 border-none outline-none text-lg p-3 mr-5' value={toLanguage} onChange={(e) => setToLanguage(e.target.value)}>
                                    {Object.entries(languages).map(([code, name]) => (
                                        <option key={code} value={code}>
                                            {name}
                                        </option>
